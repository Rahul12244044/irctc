...
import styles from "../cssModules/trainSearch.module.css";
import ModifySearch from "./modifySearch.jsx";
import {allTrains} from "../trainData/allTrains.jsx";

const API_URL = "https://mocki.io/v1/41189c39-e55b-4b7d-a236-529edfb9d3af";

export const TrainSearchResults = () => {
  ...
  useEffect(()=>{
    ...
    console.log("query in the train search: ");
    console.log(query);
  ...
  useEffect(() => {
    ...
    if (searchParams.from && searchParams.to) {
      console.log("in filteration part");
